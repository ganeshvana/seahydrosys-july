...
class MrpCostStructure(models.AbstractModel):
    _name = 'report.custom_picking.mrp_cost_analysis'
        ...
        for product in productions.mapped('product_id'):
            ...
            for product_id, mo_id, qty, cost in self.env.cr.fetchall():
                ...
                raw_material_moves.append({
                    ...
                    'mrp': self.env['mrp.production'].browse(mo_id)
                })
                total_cost += cost
...
class ProductTemplateCostStructure(models.AbstractModel):
    _name = 'report.custom_picking.product_template_mrp_cost_analysis'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        res = self.env['report.custom_picking.mrp_cost_analysis'].get_lines(productions)
        return {'lines': res}
