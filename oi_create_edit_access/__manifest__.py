...
'category' : 'Accounting',
'depends' : ['base', 'account','sale','purchase','stock','account_accountant','helpdesk','l10n_in_sale','sale_mrp','sale_crm','sale_stock','sale_purchase','sale_management','sale_project',],
