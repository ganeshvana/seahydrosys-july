...
class AccountFollowupReportCus(models.AbstractModel):
    ...
    def _get_html_render_values(self, options, report_manager):
        # OVERRIDE
        res = super(AccountFollowupReportCus, self)._get_html_render_values(options, report_manager)
    ...
    def get_html(self, options, line_id=None, additional_context=None):
        ...
        return super(AccountFollowupReportCus, self).get_html(options, line_id=line_id, additional_context=additional_context)
    ...
    def _get_templates(self):
        ...
        """
        templates = super(AccountFollowupReportCus, self)._get_templates()
    ...
    def send_email(self, options):
        ...
        if email and email.strip():
            ...
            partner.with_context(mail_post_autofollow=True).message_post(
                ...
                email_cc='anand@seahydrosys.com',
